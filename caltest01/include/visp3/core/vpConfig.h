...
#  define VISP_HAVE_OPENCV_VERSION (4<<16 | 0<<8 | 0)
#endif
...
#define VISP_SCENES_DIR "/data/tzwang/calibration/visp-3.1.0/build/data/wireframe-simulator;/usr/local/share/visp-3.1.0/data/wireframe-simulator"

// Defined the path to the robot's arms 3D model used by the robot simulators
#define VISP_ROBOT_ARMS_DIR "/data/tzwang/calibration/visp-3.1.0/build/data/robot-simulator;/usr/local/share/visp-3.1.0/data/robot-simulator"

// Defined if Ogre3d is available.
#define VISP_HAVE_OGRE

// Defined if Ogre3d plugins.cfg is available.
#define VISP_HAVE_OGRE_PLUGINS_PATH "/data/tzwang/calibration/visp-3.1.0/build/data/ogre-simulator;/usr/local/lib/visp/data/ogre-simulator"

// Defined if Ogre3d resources.cfg is available.
#define VISP_HAVE_OGRE_RESOURCES_PATH "/data/tzwang/calibration/visp-3.1.0/build/data/ogre-simulator;/usr/local/share/visp-3.1.0/data/ogre-simulator"
...
#define VISP_HAVE_LIBFREENECT_AND_DEPENDENCIES
