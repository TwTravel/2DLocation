...
if __name__ == '__main__':
    ...
    q_pos = np.array([0.0026713586412370205, -0.682586971913473, 1.8702712059020996, -3.7094839254962366, -1.6714461485492151, 1.6019178628921509])
    # q_pos = np.array([np.pi/3.0, np.pi/3.0, np.pi/3.0, np.pi/3.0, np.pi/3.0, np.pi/3.0]) + q_init
    transform = forward(q_pos)
    pos = transform[0:3, 3]
